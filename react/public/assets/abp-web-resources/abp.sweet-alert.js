...
(function () {
  var showMessage = function (type, message, title, options) {
    ...
    options.confirmButtonText =
      options.confirmButtonText ||
      abp.localization.localize("Ok", "PionereeDemo");
  ...
  abp.message.confirm = function (message, title, callback, options) {
    ...
    options.title = title
      ? title
      : abp.localization.localize("AreYouSure", "PionereeDemo");
    options.icon = options.icon || "warning";

    options.confirmButtonText =
      options.confirmButtonText ||
      abp.localization.localize("Yes", "PionereeDemo");
    options.cancelButtonText =
      options.cancelButtonText ||
      abp.localization.localize("Cancel", "PionereeDemo");
    options.showCancelButton =
      options.showCancelButton === false ? false : true;
