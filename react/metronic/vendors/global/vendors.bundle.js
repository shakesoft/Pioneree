(!(function (t, e) {
  ...
  function d(t, e) {
    ...
    if ((t !== a && e !== a) || i.contains(o))
      return "BODY" === (l = (s = a).nodeName) ||
        ("HTML" !== l && p(s.firstElementChild) !== s)
        ? p(a)
        : a;
    var c = u(t);
  ...
  function D(t, e, n, i) {
    ((n.updateBound = i),
      A(t).addEventListener("resize", n.updateBound, { passive: !0 }));
    var o = a(t);
    return (
      (function t(e, n, i, o) {
  ...
  function z(t, e, n, i) {
    ...
    var a = /\s*,\s*|\s+/,
      c =
        -1 !== l
          ? [
              s.slice(0, l).concat([s[l].split(a)[0]]),
              [s[l].split(a)[1]].concat(s.slice(l + 1)),
            ]
          : [s];
    return (
          ...
          fn: function (t, e) {
            ...
            var s = void 0 !== r ? r : e.gpuAcceleration,
              ...
              h = (function (t, e) {
                ...
                return {
                  left: p(
                    a % 2 == 1 && c % 2 == 1 && !f && e ? i.left - 1 : i.left,
                  ),
                  top: u(i.top),
                  bottom: u(i.bottom),
                  right: p(i.right),
        ...
        applyStyle: {
          ...
          fn: function (t) {
            ...
            return (
              ...
              t.arrowElement &&
                ...
                I(t.arrowElement, t.arrowStyles),
              t
            );
          },
          onLoad: function (t, e, n, i, o) {
            ...
            return (
              ...
              I(e, { position: n.positionFixed ? "fixed" : "absolute" }),
              n
            );
          },
    ...
    $ = (function () {
      function t(e, n) {
        ...
        (w(this, t),
          ...
          Object.keys(L({}, t.Defaults.modifiers, s.modifiers)).forEach(
            function (e) {
              i.options.modifiers[e] = L(
                {},
  ...
  return (
    ($.Utils = ("undefined" != typeof window ? window : global).PopperUtils),
    ($.placements = U),
    ($.Defaults = G),
    $
  );
          ...
          n(r, [
            {
              ...
              value: function (t, e, n, i) {
                ...
                ((r.id = "tooltip_" + Math.random().toString(36).substr(2, 10)),
            ...
            },
            {
              ...
              value: function (e, n) {
                ...
                return (
                  this._append(r, s),
                  (this._popperOptions = i({}, n.popperOptions, {
                    placement: n.placement,
                  })),
                  (this._popperOptions.modifiers = i(
                    {},
                  ...
                  window.setTimeout(function () {
                    if (
                      ...
                      if ("mouseleave" === i.type)
                        if (o._setTooltipNodeEvent(i, t, e, n)) return;
                      o._hide(t, n);
                    }
                  }, r));
              },
            },
            {
              ...
              value: function (t) {
                if (void 0 !== this._tooltipNode) {
                  var e = this._tooltipNode.querySelector(
                  ...
                  void 0 !== this.options.title && (this.options.title = t);
              },
            },
            {
          ...
          (this._setTooltipNodeEvent = function (e, n, i, o) {
            ...
            return (
              ...
              (t._tooltipNode.addEventListener(e.type, function i(r) {
                ...
                (t._tooltipNode.removeEventListener(e.type, i),
                  n.contains(s) || t._scheduleHide(n, o.delay, o, r));
              }),
              !0)
            );
          }));
  ...
  (function (t, e) {
    ...
    var m = function (t, e, n, i, o) {
      ...
      !(function (t, e, n, i, o) {
        ...
        e &&
          ...
          e < 0
            ? u.dispatchEvent(d("ps-scroll-" + f))
            : e > 0 && u.dispatchEvent(d("ps-scroll-" + p)),
          i &&
            (function (t, e) {
              (c(t, e), h(t, e));
            })(t, a));
        t.reach[a] &&
          (e || o) &&
          u.dispatchEvent(d("ps-" + a + "-reach-" + t.reach[a]));
      })(t, n, r, i, o);
    };
    function v(t) {
        ...
        ((t.containerWidth = n.clientWidth),
          ...
          t.containerWidth + t.settings.scrollXMarginOffset < t.contentWidth
            ? ((t.scrollbarXActive = !0),
              ...
              (t.scrollbarXWidth = w(
                t,
                v((t.railXWidth * t.containerWidth) / t.contentWidth),
              )),
              (t.scrollbarXLeft = v(
          ...
          t.containerHeight + t.settings.scrollYMarginOffset < t.contentHeight
            ? ((t.scrollbarYActive = !0),
              ...
              (t.scrollbarYHeight = w(
                t,
                v((t.railYHeight * t.containerHeight) / t.contentHeight),
              )),
              (t.scrollbarYTop = v(
          ...
          (function (t, n) {
            ...
            n.isScrollbarXUsingBottom
              ? (i.bottom = n.scrollbarXBottom - o)
              : (i.top = n.scrollbarXTop + o);
    ...
    function y(t, e) {
      ...
      function y() {
        (h(t, p),
          t[u].classList.remove(l.state.clicking),
          t.event.unbind(t.ownerDocument, "mousemove", w));
      }
              ...
              (e.settings.useBothWheelAxes
                ? e.scrollbarYActive && !e.scrollbarXActive
                  ? (s
                      ...
                      : (n.scrollTop += r * e.settings.wheelSpeed),
                    (a = !0))
                  : e.scrollbarXActive &&
                    !e.scrollbarYActive &&
                    (r
                      ? (n.scrollLeft += r * e.settings.wheelSpeed)
        ...
        touch: function (e) {
          if (g.supportsTouch || g.supportsIePointer) {
            var n = e.element,
              ...
              s = null;
            g.supportsTouch
              ? (e.event.bind(n, "touchstart", f),
                e.event.bind(n, "touchmove", p),
                e.event.bind(n, "touchend", u))
              : g.supportsIePointer &&
                (window.PointerEvent
      ...
      L = function (i, o) {
        ...
        ((this.scrollbarXBottom = parseInt(p.bottom, 10)),
          isNaN(this.scrollbarXBottom)
            ? ((this.isScrollbarXUsingBottom = !1),
              (this.scrollbarXTop = v(p.top)))
            : (this.isScrollbarXUsingBottom = !0),
          (this.railBorderXWidth =
            v(p.borderLeftWidth) + v(p.borderRightWidth)),
        ...
        ((this.scrollbarYRight = parseInt(d.right, 10)),
          ...
          (this.railBorderYWidth =
            v(d.borderTopWidth) + v(d.borderBottomWidth)),
      ...
      (L.prototype.update = function () {
        this.isAlive &&
          ...
          (this.railXMarginWidth =
            v(t(this.scrollbarXRail).marginLeft) +
            v(t(this.scrollbarXRail).marginRight)),
          (this.railYMarginHeight =
            v(t(this.scrollbarYRail).marginTop) +
            v(t(this.scrollbarYRail).marginBottom)),
