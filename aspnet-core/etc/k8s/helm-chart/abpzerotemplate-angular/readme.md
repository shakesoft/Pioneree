...
```bash
docker build -t abpzerotemplate-host -f src\PionereeDemo.Web.Host\Dockerfile .
docker build -t abpzerotemplate-migrator -f src\PionereeDemo.Migrator\Dockerfile .
```
