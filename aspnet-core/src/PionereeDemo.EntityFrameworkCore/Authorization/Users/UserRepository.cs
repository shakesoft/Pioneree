...
public class UserRepository : PionereeDemoRepositoryBase<User, long>, IUserRepository
{
    public UserRepository(IDbContextProvider<PionereeDemoDbContext> dbContextProvider)
