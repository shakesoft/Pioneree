...
public class SubscriptionPaymentRepository : PionereeDemoRepositoryBase<SubscriptionPayment, long>,
    ISubscriptionPaymentRepository
{
    public SubscriptionPaymentRepository(IDbContextProvider<PionereeDemoDbContext> dbContextProvider)
