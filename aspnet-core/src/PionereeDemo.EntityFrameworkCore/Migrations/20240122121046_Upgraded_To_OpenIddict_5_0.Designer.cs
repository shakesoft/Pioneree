...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PionereeDemo.Authorization.Delegation.UserDelegation", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("PionereeDemo.Authorization.Users.RecentPassword", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("PionereeDemo.MultiTenancy.Payments.SubscriptionPaymentProduct", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("PionereeDemo.OpenIddict.Applications.OpenIddictApplication", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("PionereeDemo.OpenIddict.Authorizations.OpenIddictAuthorization", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("PionereeDemo.OpenIddict.Scopes.OpenIddictScope", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("PionereeDemo.OpenIddict.Tokens.OpenIddictToken", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("PionereeDemo.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("PionereeDemo.Authorization.Users.User", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("PionereeDemo.MultiTenancy.Payments.SubscriptionPaymentProduct", b =>
                {
                    b.HasOne("PionereeDemo.MultiTenancy.Payments.SubscriptionPayment", null)
            ...
            modelBuilder.Entity("PionereeDemo.OpenIddict.Authorizations.OpenIddictAuthorization", b =>
                {
                    b.HasOne("PionereeDemo.OpenIddict.Applications.OpenIddictApplication", null)
                        .WithMany()
            ...
            modelBuilder.Entity("PionereeDemo.OpenIddict.Tokens.OpenIddictToken", b =>
                {
                    ...
                    b.HasOne("PionereeDemo.OpenIddict.Authorizations.OpenIddictAuthorization", null)
                        .WithMany()
