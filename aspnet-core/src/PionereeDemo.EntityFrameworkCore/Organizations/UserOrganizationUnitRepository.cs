...
using PionereeDemo.EntityFrameworkCore.Repositories;

namespace PionereeDemo.Organizations;

public class UserOrganizationUnitRepository : PionereeDemoRepositoryBase<UserOrganizationUnit, long>,
    IUserOrganizationUnitRepository
{
    public UserOrganizationUnitRepository(IDbContextProvider<PionereeDemoDbContext> dbContextProvider)
