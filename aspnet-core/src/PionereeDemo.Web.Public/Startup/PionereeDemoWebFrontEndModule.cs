...
namespace PionereeDemo.Web.Public.Startup;

[DependsOn(
    typeof(PionereeDemoWebCoreModule)
)]
public class PionereeDemoWebFrontEndModule : AbpModule
{
    private readonly IConfigurationRoot _appConfiguration;

    public PionereeDemoWebFrontEndModule(IWebHostEnvironment env, PionereeDemoEntityFrameworkCoreModule abpZeroTemplateEntityFrameworkCoreModule)
    {
    ...
    {
        IocManager.RegisterAssemblyByConvention(typeof(PionereeDemoWebFrontEndModule).GetAssembly());
    }
}
