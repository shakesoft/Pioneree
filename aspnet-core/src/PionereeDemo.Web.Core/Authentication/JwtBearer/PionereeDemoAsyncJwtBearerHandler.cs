...
public class PionereeDemoAsyncJwtBearerHandler : AuthenticationHandler<AsyncJwtBearerOptions>
{
    ...
    /// </summary>
    /// <inheritdoc />
    public PionereeDemoAsyncJwtBearerHandler(IOptionsMonitor<AsyncJwtBearerOptions> options,
