...
/// </summary>
public static class PionereeDemoJwtBearerExtensions
{
    /// <summary>
    ...
    public static AuthenticationBuilder AddAbpAsyncJwtBearer(this AuthenticationBuilder builder, string authenticationScheme, string? displayName, Action<AsyncJwtBearerOptions> configureOptions)
    {
        ...
        return builder.AddScheme<AsyncJwtBearerOptions, PionereeDemoAsyncJwtBearerHandler>(authenticationScheme, displayName, configureOptions);
    }
}
