...
using PionereeDemo.Authorization.Users.Password;
using PionereeDemo.Configuration;
using PionereeDemo.EntityFrameworkCore;
using PionereeDemo.MultiTenancy;
using PionereeDemo.MultiTenancy.Subscription;
using PionereeDemo.Web.Startup.ExternalLoginInfoProviders;

namespace PionereeDemo.Web.Startup;

[DependsOn(
    typeof(PionereeDemoWebCoreModule)
)]
public class PionereeDemoWebHostModule : AbpModule
{
    private readonly IWebHostEnvironment _env;
    private readonly IConfigurationRoot _appConfiguration;

    public PionereeDemoWebHostModule(
    ...
    {
        IocManager.RegisterAssemblyByConvention(typeof(PionereeDemoWebHostModule).GetAssembly());
    }
