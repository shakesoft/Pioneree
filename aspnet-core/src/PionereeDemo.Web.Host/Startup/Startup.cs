...
using PionereeDemo.Web.Chat.SignalR;
using PionereeDemo.Web.Common;
using PionereeDemo.Web.Swagger;
using Stripe;
...
using PionereeDemo.Schemas;
using PionereeDemo.Web.HealthCheck;
using Owl.reCAPTCHA;
using Microsoft.AspNetCore.Server.Kestrel.Https;
using PionereeDemo.Web.MultiTenancy;
using Abp.HtmlSanitizer;
using Microsoft.AspNetCore.Authentication.Cookies;
using PionereeDemo.Web.Authentication.PasswordlessLogin;
using PionereeDemo.Web.OpenIddict;
using Abp.AspNetCore.OpenIddict;
using Microsoft.OpenApi;
using PionereeDemo.Authorization.QrLogin;

namespace PionereeDemo.Web.Startup;
...
public class Startup
{
    ...
    public IServiceProvider ConfigureServices(IServiceCollection services)
    {
        ...
        return services.AddAbp<PionereeDemoWebHostModule>(options =>
        {
...
#pragma warning disable CS0162
        if (PionereeDemoConsts.PreventNotExistingTenantSubdomains)
        {
        ...
        if (WebConsts.SwaggerUiEnabled)
        {
            ...
            {
                options.SwaggerEndpoint(_appConfiguration["App:SwaggerEndPoint"], "PionereeDemo API V1");
                options.IndexStream = () => Assembly.GetExecutingAssembly()
                    .GetManifestResourceStream("PionereeDemo.Web.wwwroot.swagger.ui.index.html");
    ...
    private void ConfigureSwagger(IServiceCollection services)
    {
        ...
        {
            options.SwaggerDoc("v1", new OpenApiInfo() { Title = "PionereeDemo API", Version = "v1" });
            ...
            if (canShowSummaries)
            {
                ...
                var applicationXml = $"PionereeDemo.Application.xml";
                var applicationXmlPath = Path.Combine(AppContext.BaseDirectory, applicationXml);
                options.IncludeXmlComments(applicationXmlPath);

                var webCoreXmlFile = $"PionereeDemo.Web.Core.xml";
