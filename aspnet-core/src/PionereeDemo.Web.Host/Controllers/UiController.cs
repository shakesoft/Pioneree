...
using PionereeDemo.Web.Models.Ui;
using PionereeDemo.Web.Session;
using System.Threading.Tasks;

namespace PionereeDemo.Web.Controllers;

public class UiController : PionereeDemoControllerBase
{
    ...
    public async Task<IActionResult> Index()
    {
        ...
        if (_databaseCheckHelper.Exist(_appConfiguration[$"ConnectionStrings:{PionereeDemoConsts.ConnectionStringName}"]))
        {
