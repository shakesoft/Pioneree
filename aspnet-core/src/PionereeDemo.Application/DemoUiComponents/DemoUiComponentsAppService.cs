...
using PionereeDemo.DemoUiComponents.Dto;

namespace PionereeDemo.DemoUiComponents;

[AbpAuthorize(AppPermissions.Pages_DemoUiComponents)]
public class DemoUiComponentsAppService : PionereeDemoAppServiceBase, IDemoUiComponentsAppService
{
