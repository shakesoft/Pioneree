...
using PionereeDemo.Auditing.Exporting;
...
using EntityHistoryHelper = PionereeDemo.EntityHistory.EntityHistoryHelper;

namespace PionereeDemo.Auditing;

[DisableAuditing]
[AbpAuthorize(AppPermissions.Pages_Administration_AuditLogs)]
public class AuditLogAppService : PionereeDemoAppServiceBase, IAuditLogAppService
{
