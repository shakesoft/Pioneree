...
using PionereeDemo.Migrations.Seed.Host;
...
[AbpAllowAnonymous]
[DisableAuditing]
public class InstallAppService : PionereeDemoAppServiceBase, IInstallAppService
{
    private readonly AbpZeroDbMigrator<PionereeDemoDbContext> _migrator;
    ...
    {
        var connectionString = _appConfiguration[$"ConnectionStrings:{PionereeDemoConsts.ConnectionStringName}"];
    ...
    {
        EditAppSettingsjson($"ConnectionStrings:{PionereeDemoConsts.ConnectionStringName}", constring);
    }
