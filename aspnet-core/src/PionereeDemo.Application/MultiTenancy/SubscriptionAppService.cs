...
public class SubscriptionAppService : PionereeDemoAppServiceBase, ISubscriptionAppService
{
    ...
    {
        return upgradeAmount < PionereeDemoConsts.MinimumUpgradePaymentAmount;
    }
