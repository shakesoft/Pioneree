...
public class SessionAppService : PionereeDemoAppServiceBase, ISessionAppService
{
    ...
    public async Task<GetCurrentLoginInformationsOutput> GetCurrentLoginInformations()
    {
        ...
        var isSessionManagementEnabled = await _settingManager.GetSettingValueAsync<bool>(AppSettings.UserManagement.SessionManagement.IsEnabled);
        var isSessionRevocationEnabled = await _settingManager.GetSettingValueAsync<bool>(AppSettings.UserManagement.SessionManagement.IsSessionRevocationEnabled);
        ...
        return await _unitOfWorkManager.WithUnitOfWorkAsync(async () =>
        {
            var output = new GetCurrentLoginInformationsOutput
            {
                ...
                IsSessionRevocationEnabled = isSessionRevocationEnabled,
                Application = new ApplicationInfoDto
                {
                    Version = AppVersionHelper.Version,
                    ReleaseDate = AppVersionHelper.ReleaseDate,
                    Features = new Dictionary<string, bool>(),
                    Currency = PionereeDemoConsts.Currency,
                    CurrencySign = PionereeDemoConsts.CurrencySign,
                    AllowTenantsToChangeEmailSettings = PionereeDemoConsts.AllowTenantsToChangeEmailSettings,
