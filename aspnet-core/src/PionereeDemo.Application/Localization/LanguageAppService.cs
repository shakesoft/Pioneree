...
public class LanguageAppService : PionereeDemoAppServiceBase, ILanguageAppService
{
    ...
    {
        var languages =
            (await _applicationLanguageManager.GetLanguagesAsync(AbpSession.TenantId)).OrderBy(l => l.DisplayName).ToList();
