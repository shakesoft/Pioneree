...
public class PionereeDemoMailKitSmtpBuilder : DefaultMailKitSmtpBuilder
{
    private readonly ILocalizationManager _localizationManager;
    private readonly IEmailSettingsChecker _emailSettingsChecker;

    public PionereeDemoMailKitSmtpBuilder(
    ...
    {
        return _localizationManager.GetString(PionereeDemoConsts.LocalizationSourceName, name);
    }
