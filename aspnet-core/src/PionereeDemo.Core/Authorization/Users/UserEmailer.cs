...
/// </summary>
public class UserEmailer : PionereeDemoServiceBase, IUserEmailer, ITransientDependency
{
    ...
    public async Task SendPasswordResetLinkAsync(User user, string link = null)
    {
        ...
        if (!link.IsNullOrEmpty())
        {
            ...
            var expireDate = Uri.EscapeDataString(Clock.Now.AddHours(expirationHours)
                .ToString(PionereeDemoConsts.DateTimeOffsetFormat, CultureInfo.InvariantCulture));
