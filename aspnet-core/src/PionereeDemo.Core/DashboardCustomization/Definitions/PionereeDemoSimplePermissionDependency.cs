...
/// </summary>
public class PionereeDemoSimplePermissionDependency : IPermissionDependency
{
    /// <summary>
    ...
    /// </summary>
    public PionereeDemoSimplePermissionDependency()
    {
    ...
    public PionereeDemoSimplePermissionDependency(params string[] permissions)
    {
    ...
    /// </param>
    /// <param name="permissions">The permissions.</param>
    public PionereeDemoSimplePermissionDependency(bool requiresAll, params string[] permissions)
        : this(permissions)
    {
