...
using PionereeDemo.DashboardCustomization.Definitions.Cache;

namespace PionereeDemo.DashboardCustomization.Definitions;
...
public class DashboardConfiguration : ITransientDependency
{
        ...
        IAbpSession abpSession)
    {
        ...
        var dateRangeFilter = new WidgetFilterDefinition(
            PionereeDemoDashboardCustomizationConsts.Filters.FilterDateRangePicker,
        ...
        var simplePermissionDependencyForTenantDashboard =
            new PionereeDemoSimplePermissionDependency(AppPermissions.Pages_Tenant_Dashboard);

        var dailySales = new WidgetDefinition(
            PionereeDemoDashboardCustomizationConsts.Widgets.Tenant.DailySales,
            "WidgetDailySales",
        ...
        var generalStats = new WidgetDefinition(
            PionereeDemoDashboardCustomizationConsts.Widgets.Tenant.GeneralStats,
            "WidgetGeneralStats",
            side: MultiTenancySides.Tenant,
            permissionDependency: new PionereeDemoSimplePermissionDependency(
                requiresAll: true,
        ...
        var profitShare = new WidgetDefinition(
            PionereeDemoDashboardCustomizationConsts.Widgets.Tenant.ProfitShare,
            "WidgetProfitShare",
            side: MultiTenancySides.Tenant,
            permissionDependency: simplePermissionDependencyForTenantDashboard
        );
        ...
        var memberActivity = new WidgetDefinition(
            PionereeDemoDashboardCustomizationConsts.Widgets.Tenant.MemberActivity,
        ...
        var regionalStats = new WidgetDefinition(
            PionereeDemoDashboardCustomizationConsts.Widgets.Tenant.RegionalStats,
            "WidgetRegionalStats",
            side: MultiTenancySides.Tenant,
            permissionDependency: simplePermissionDependencyForTenantDashboard
        );
        ...
        var salesSummary = new WidgetDefinition(
            PionereeDemoDashboardCustomizationConsts.Widgets.Tenant.SalesSummary,
            "WidgetSalesSummary",
            usedWidgetFilters: new List<string>() { dateRangeFilter.Id },
            side: MultiTenancySides.Tenant,
            permissionDependency: simplePermissionDependencyForTenantDashboard
        ...
        var topStats = new WidgetDefinition(
            PionereeDemoDashboardCustomizationConsts.Widgets.Tenant.TopStats,
            "WidgetTopStats",
            side: MultiTenancySides.Tenant,
            permissionDependency: simplePermissionDependencyForTenantDashboard
        );
        ...
        var simplePermissionDependencyForHostDashboard =
            new PionereeDemoSimplePermissionDependency(AppPermissions.Pages_Administration_Host_Dashboard);

        var incomeStatistics = new WidgetDefinition(
            PionereeDemoDashboardCustomizationConsts.Widgets.Host.IncomeStatistics,
        ...
        var hostTopStats = new WidgetDefinition(
            PionereeDemoDashboardCustomizationConsts.Widgets.Host.TopStats,
            "WidgetTopStats",
            side: MultiTenancySides.Host,
            permissionDependency: simplePermissionDependencyForHostDashboard
        );
        ...
        var editionStatistics = new WidgetDefinition(
            PionereeDemoDashboardCustomizationConsts.Widgets.Host.EditionStatistics,
        ...
        var subscriptionExpiringTenants = new WidgetDefinition(
            PionereeDemoDashboardCustomizationConsts.Widgets.Host.SubscriptionExpiringTenants,
        ...
        var recentTenants = new WidgetDefinition(
            PionereeDemoDashboardCustomizationConsts.Widgets.Host.RecentTenants,
            "WidgetRecentTenants",
            side: MultiTenancySides.Host,
            usedWidgetFilters: new List<string>() { dateRangeFilter.Id },
            permissionDependency: simplePermissionDependencyForHostDashboard
        ...
        var defaultTenantDashboard = new DashboardDefinition(
            PionereeDemoDashboardCustomizationConsts.DashboardNames.DefaultTenantDashboard,
            new List<string>
            {
        ...
        var defaultHostDashboard = new DashboardDefinition(
            PionereeDemoDashboardCustomizationConsts.DashboardNames.DefaultHostDashboard,
            new List<string>
            {
                    incomeStatistics.Id,
                    hostTopStats.Id,
