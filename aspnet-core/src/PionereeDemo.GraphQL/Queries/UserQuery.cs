...
public class UserQuery : PionereeDemoQueryBase<UserPagedResultGraphType, PagedResultDto<UserDto>>
{
    ...
    private async Task<List<UserDto>> AddOrganizationUnitsOfUsers(List<User> users, List<UserDto> userDtos)
    {
        ...
        userDtos.ForEach(userDto =>
        {
            ...
            {
                userDto.OrganizationUnits = ObjectMapper.Map<List<UserDto.OrganizationUnitDto>>(
