...
namespace PionereeDemo.Core.Base;

public abstract class PionereeDemoQueryBase<TField, TResult> : ITransientDependency
{
    ...
    protected PionereeDemoQueryBase(string fieldName,
