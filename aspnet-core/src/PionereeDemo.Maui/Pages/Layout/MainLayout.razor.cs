...
using PionereeDemo.Maui.Core.Helpers;
...
using PionereeDemo.Maui.Services.Tenants;
using PionereeDemo.Maui.Services.UI;

#if ANDROID
using PionereeDemo.Maui.Core.Platforms.Android.HttpClient;
#endif
#if IOS
using PionereeDemo.Maui.Core.Platforms.iOS.HttpClient;
#endif
