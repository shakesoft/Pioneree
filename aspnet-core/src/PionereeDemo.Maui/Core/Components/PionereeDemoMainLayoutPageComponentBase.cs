...
using PionereeDemo.Maui.Services.Permission;
using PionereeDemo.Maui.Services.UI;

namespace PionereeDemo.Maui.Core.Components;

public class PionereeDemoMainLayoutPageComponentBase : PionereeDemoComponentBase
{
    ...
    public PionereeDemoMainLayoutPageComponentBase()
    {
