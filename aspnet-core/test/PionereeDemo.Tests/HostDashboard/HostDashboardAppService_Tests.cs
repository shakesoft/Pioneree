...
using PionereeDemo.MultiTenancy.HostDashboard;
...
namespace PionereeDemo.Tests.HostDashboard;
...
public class HostDashboardAppService_Tests : AppTestBase
{
    ...
    private void CreatePaidPayment(PionereeDemoDbContext context, SubscriptionPayment subscriptionPayment)
    {
